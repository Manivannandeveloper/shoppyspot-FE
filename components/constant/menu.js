export const MENUITEMS = [
      ...
      title: 'Products', type: 'sub', children: [
         {
            title: 'Mobile', type: 'sub', children: [
               { path: '/product-details/44-shoes2', title: 'OnePlus', type: 'link' },
               { path: '/product-details/44-shoes2', title: 'boAt', type: 'link' },
            ]
         },
         {
            title: "Electronics", type: "sub", children: [
               { path: '#', title: 'Card Holders', type: 'link' },
   ...
   { path: '/page/account/contact', title: 'contact us', type: 'link', children:false},
   // {
