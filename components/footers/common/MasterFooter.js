                ...
                >
                  <div className="footer-contant">
                    ...
                    <div className="footer-social">
                      <ul>
                        <li>
                          <a href="https://www.facebook.com/HealthBeautyBank" target="_blank">
                            <i
                        ...
                        <li>
                          <a href="https://twitter.com/healthbeautyban" target="_blank">
                            <i className="fa fa-twitter" aria-hidden="true"></i>
                          </a>
                        </li>
                        <li>
                          <a href="https://www.instagram.com/healthbeautybank" target="_blank">
                            <i
                        ...
                        <li>
                          <a href="https://www.linkedin.com/healthbeautybank" target="_blank">
                    ...
                    <div className="footer-contant">
                      <ul className="contact-list">
                        ...
                        <li>
                          ...
                          <a href="#">info@healthbeautybank.com</a>
                        </li>
                        <li>
