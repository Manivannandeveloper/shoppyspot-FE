  ...
  return (
    <div>
      <a href={null} onClick={() => openSetting()}>
        <div className="setting-sidebar hide" id="setting-icon">
          <div>
      ...
      <div className="sidebar-btn dark-light-btn hide">
      ...
      <div className="addcart_btm_popup hide" id="fixed_cart_icon">
